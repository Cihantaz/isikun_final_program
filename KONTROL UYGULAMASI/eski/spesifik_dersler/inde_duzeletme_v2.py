...
oneri = {
    ...
    'INDE3314': (7, 1),    # G1S1 -> G7S1: INDE3312 ile DiffDay coz, 0 cakisma
    'INDE2002': (5, 2),    # G5S3 -> G5S2: INDE2001'den ayir, 0 cakisma
}

print("=" * 100)
print("DUZELTME ONERISI v2")
print("=" * 100)
...
for d, (g_yeni, s_yeni) in oneri.items():
    ...
    neden = {
        'INDE2452': 'INDE2211 ile 18 ogrenci cakismasini cozer',
        'INDE3314': 'INDE3312 ile DiffDay ihlalini cozer (G1->G7)',
        'INDE2002': 'INDE2001 ile ayni slot ihlalini cozer',
    }[d]
    print(f"  {d}: G{g_eski}S{s_eski} -> G{g_yeni}S{s_yeni} | {neden}")
...
print("\n" + "=" * 100)
print("TUM OGRENCI CAKISMALARI (DUZELTMEDEN SONRA)")
print("=" * 100)
...
print(f"INDE-INDE CAKISMASI: {inde_cakisma} ogrenci")
